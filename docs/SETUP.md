...
```env
DATABASE_URL=postgresql://prysm:password@localhost:5432/prysm
...
# Run migrations
psql -d prysm -f database/migrations/001_initial_schema.sql
psql -d prysm -f database/migrations/002_wallet_payments.sql
```
...
| Worker (Zomato) | 8856543210 | worker123 |
| Workers (Others) | 9876543211–14 | worker123 |
